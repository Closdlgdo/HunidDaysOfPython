def increment(number, by=2):  # we can create the by parameter as an option.
    return number + by


print(increment(5))  # we can create the by parameter as an option and when we pass it to the
